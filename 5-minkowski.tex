...
\begin{lema}
  ...
  \begin{proof}
    ...
    entonces podemos tomar como $X$ el dominio fundamental $\Pi$. De una vez
...
\begin{comentario}
  ...
  funcionaría la desigualdad
  $$\vol (X) \ge 2^n \, \covol \Lambda.$$
\end{comentario}
...
\begin{lema}[{Blichfeldt\footnote{Hans Frederick Blichfeldt (1873--1945), matemático danés.}}]
  ...
  $X\subset V$ tal que $\vol X > \covol \Lambda$, existen dos
...
\begin{comentario}
  ...
  en $\ZZ$ podemos definir el conjugado de $\alpha = a + bi + cj + dk$
