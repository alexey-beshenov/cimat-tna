...
\begin{ejercicio}
  Demuestre que para cualquier campo de números $K/\QQ$ y $N$ fijo hay un número
  finito de ideales $I \subseteq \O_K$ con la norma $N_{K/\QQ} (I) \le N$.

  \noindent (Indicación: use la factorización de ideales en ideales primos y
  la multiplicatividad de la norma.)
\end{ejercicio}
